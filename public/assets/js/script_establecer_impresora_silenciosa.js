const RUTA_API = "https://localhost:8000";
...
$btnImprimir.addEventListener("click", (event) => {
    let prueba = @json('hola');
    console.log(prueba);
    let impresora = new Impresora(RUTA_API);
    impresora.setFontSize(1, 1);
    impresora.setEmphasize(0);
    impresora.setAlign("center");
    impresora.write("bullshop S.A.C.\n");
    impresora.write("DIRECCION DE PRUEBA\n");
    ...
    impresora.write("--------------------------------\n");
    impresora.write("SUBTOTAL: 25 USD\n");
    impresora.write("DESCUENTO: 25 USD\n");
    impresora.write("TOTAL: 25 USD\n");
    impresora.write("--------------------------------\n");
    impresora.setAlign("center");
    impresora.write("***Gracias por su compra***");
    impresora.cut();
    impresora.cutPartial(); // Po ngo este y también cut porque en ocasiones no funciona con cut, solo con cutPartial
    impresora.end()
        .then(valor => {
