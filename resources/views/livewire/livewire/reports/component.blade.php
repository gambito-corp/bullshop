                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-2">
                                <h6>fecha desde</h6>
                                <div class="form-group">
                                    <input type="text" {{$reportType == 0 ? 'disabled' : '' }} wire:model="dateFrom" class="form-control flatpickr"
                            ...
                            <div class="col-sm-12 mt-2">
                                <h6>fecha hasta</h6>
                                <div class="form-group">
                                    <input type="text" {{$reportType == 0 ? 'disabled' : '' }} wire:model="dateTo" class="form-control flatpickr"
                                        placeholder="Click para elegir">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $d)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <h6> {{env('MONEDA', 'S/. ')}}{{ number_format($d->total, 2) }}</h6>
                                            </td>
                                            <td class="text-center">
                                                <h6> {{ $d->items }}</h6>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <h6> {{ \Carbon\Carbon::parse($d->created_at)->format('d-m-Y H:i:s') }}
                                                </h6>
                                            </td>
