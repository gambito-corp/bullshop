                    ...
                    <table class="table table-bordered table-striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><h6>{{env('MONEDA', 'S/. ')}}{{number_format($d->price,2)}}</h6></td>
                                <td class="text-center"><h6>{{env('MONEDA', 'S/. ')}}{{number_format($d->quantity * $d->price,2)}}</h6></td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                            ...
                            @if($details)
                                ...
                                @endforeach
                                <td></td>
                                <td class="text-center"><h6 class="text-info">{{env('MONEDA', 'S/. ')}}{{number_format($mytotal,2)}}</h6></td>
                            @endif
                        </tfoot>
                    </table>
                </div>
