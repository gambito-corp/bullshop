                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" {{$userid == 0 ? 'disabled' : ''}} wire:model.lazy="fromDate" class="form-control">
                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" {{$userid == 0 ? 'disabled' : ''}} wire:model.lazy="toDate" class="form-control">
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        @forelse ($FormasDePago as $item)
                        {{-- @dump($item) --}}
                        <h5 class="text-white">Ventas por {{$item['tipo']}}: {{env('MONEDA', 'S/. ')}}{{number_format($item['valor'],2)}}</h5>
                        @empty
                        <h5 class="text-white">Por Medios de pago</h5>
                        @endforelse
                        <h5 class="text-white">Ventas Reales: {{env('MONEDA', 'S/. ').number_format($FormasDePago->sum('valor'))}}</h5>
                        
                        <hr>
                        <h5 class="text-white">Ventas Totales Sin Descuento: {{env('MONEDA', 'S/. ')}}{{number_format($total,2)}}</h5>
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><h6>{{env('MONEDA', 'S/. ')}}{{number_format($row->total,2)}}</h6></td>
