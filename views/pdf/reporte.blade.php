            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class="text-center">{{env('MONEDA', 'S/. ')}}{{number_format($item->costoTotal,2)}}</td>
                        <td class="text-center">{{env('MONEDA', 'S/. ')}}{{number_format($item->total,2)}}</td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-center" colspan="1"> 
                        <span><strong>{{env('MONEDA', 'S/. ')}}{{number_format($data->sum('total'),2)}}</strong> </span>
                    </td>
                    <td class="text-center">
                        {{$data->sum('items')}}
                    </td>
