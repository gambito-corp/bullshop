                        ...
                        <div class="row justify-content-between mt-5">
                            ...
                            <div class="col sm-12 col-md-12 col-lg-6">
                                @if ($efectivo >= $total && $total > 0)
                                    @if($guardar == false)
                                        <button wire:click.prevent="Cerrar({{$cart}})" class="btn btn-dark btn-md btn-block">
                                            SALVAR VENTA F9
                                        </button>
                                    @endif
                                @endif
                                @if($guardar == true)
                                    <button wire:click.prevent="saveSale({{$productosImpresion}})" class="btn btn-dark btn-md btn-block">
                                        Imprimir tiket
                                    </button>
                                @endif
                            </div>
